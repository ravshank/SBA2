...
public class ManagerController {
	...
	public ResponseEntity<RejectDto> rejectLoan(@PathVariable Long managerId,
		...
		RejectDto rejectloan = this.managerService.rejectLoan(managerId, loanAppId, rejectDto);
		ResponseEntity <RejectDto> response = new ResponseEntity<RejectDto>(rejectloan, HttpStatus.OK);
		return response;
	}
